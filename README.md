...
Set the `Version` number in the <a href="https://github.com/mhlabs/MhLabs.AWSCognitoExtensions/blob/master/MhLabs.AWSCognitoExtensions/MhLabs.AWSCognitoExtensions.csproj"> .csproj-file</a> before pushing. If an existing version is pushed the <a href="https://github.com/mhlabs/MhLabs.AWSCognitoExtensions/actions">build will fail</a>.
